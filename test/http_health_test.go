...
func TestHealthEndpoints(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/v1/healthz", nil) // Create a GET request.
	...
	req2 := httptest.NewRequest(http.MethodGet, "/v1/readyz", nil) // Create another GET request.
